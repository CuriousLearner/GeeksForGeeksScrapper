...
def save_articles_as_html_and_pdf():
    ...
    all_articles += '<h1 style="text-align:center;font-size:40px">' + categoryUrl.title() + ' Archive</h1><hr>'
    all_articles += '<h1 style="padding-left:5%;font-size:200%;">Index</h1><br/>'
    for x in range(len(articles)):
        all_articles += '<a href =\"#' + str(x+1) + '\">' + '<h1 style="padding-left:5%;font-size:20px;">' + str(x+1) + ".\t\t"+articles[x].title + '</h1></a> <br/>'
    for x in range(len(articles)):
